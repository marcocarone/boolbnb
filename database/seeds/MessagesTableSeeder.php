	...
	*/
	...
	$messageTemplate = [
		'message' => [
			...
			'Era la prima volta che mi sono scritta sul sito airbnb , e risulta che l aereolinea mi ha cancellato il volo destinazione Roma . Ho dovuto cancellare la prenotazione ',
			'Leggo con molto dispiacere e stupore tutti questi messaggi negativi su Airbnb e sugli Host. Siete stati davvero sfortunati, nella mia zona, il Chianti Classico mai sentito cose del genere, noi host siamo molto seri e l\'obiettivo principale è fare trovare le case pulite, ordinate, con biancheria fresca e pulita e soprattutto il rapporto con il Cliente che è fondamentale',
