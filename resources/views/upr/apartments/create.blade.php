...
<div class="ap-create-show__title bg-grey">
    <div class="wrapper">
        <div class="ap-title-price">
            <div class="left">
                <h3>Crea un annuncio</h3>
                <p>In pochi minuti inizierai a creare la pagina del tuo annuncio.</p>
            </div>
            <div class="right">
										...
										<div class="home-apartment__box">
												<div class="thumb">
													<div class="thumb_container">
														<img id="blah" class="img-whp" src="#" alt="">
													</div>
													<div class="thmb_cntnt">
														<p id="price-append" class="fp_price">Prezzo</p>
														<small>€</small>
													</div>
												</div>
												<div class="details">
													<div class="tc_content">
														<div class="tc_content__height">
																<h4 id="title-append" >Titolo</h4>
														</div>
														<p id="address-append"><span></span>Indirizzo</p>
														<ul class="prop_details">
															<li>Stanze: <strong id="room-append"></strong> </li>
															<li>Bagni: <strong id="bath-append"></strong> </li>
															<li>Mq: <strong id="mq-append"></strong> </li>
														</ul>
													</div>
												</div>
										</div>
